-- FORÇAR APAGAR TUDO NO AZURE - SCRIPT DEFINITIVO
-- Execute este script no Azure Portal

PRINT '=== FORÇANDO REMOÇÃO DE TODAS AS TABELAS ===';

-- 1. DESABILITAR FOREIGN KEYs E APAGAR TUDO
...
BEGIN
    ...
    BEGIN
        ...
        PRINT '✅ FOREIGN KEYs removidas de Orcamentos';
    END
    
    DROP TABLE Orcamentos;
    PRINT '✅ Tabela Orcamentos FORÇADAMENTE apagada';
END
...
BEGIN
    ...
    SELECT @sql2 = @sql2 + 'ALTER TABLE OrdensServico DROP CONSTRAINT ' + CONSTRAINT_NAME + ';' + CHAR(13)
    FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS 
    ...
    BEGIN
        ...
        PRINT '✅ FOREIGN KEYs removidas de OrdensServico';
    END
    
    DROP TABLE OrdensServico;
    PRINT '✅ Tabela OrdensServico FORÇADAMENTE apagada';
END
...
BEGIN
    ...
    SELECT @sql3 = @sql3 + 'ALTER TABLE Veiculos DROP CONSTRAINT ' + CONSTRAINT_NAME + ';' + CHAR(13)
    FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS 
    ...
    BEGIN
        ...
        PRINT '✅ FOREIGN KEYs removidas de Veiculos';
    END
    
    DROP TABLE Veiculos;
    PRINT '✅ Tabela Veiculos FORÇADAMENTE apagada';
END

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Clientes')
BEGIN
    DROP TABLE Clientes;
    PRINT '✅ Tabela Clientes FORÇADAMENTE apagada';
END

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Usuarios')
BEGIN
    DROP TABLE Usuarios;
    PRINT '✅ Tabela Usuarios FORÇADAMENTE apagada';
END

PRINT '=== TODAS AS TABELAS APAGADAS COM SUCESSO ===';
...
PRINT '✅ Tabela Usuarios criada com estrutura correta';
...
PRINT '✅ Todas as tabelas FORÇADAMENTE apagadas';
